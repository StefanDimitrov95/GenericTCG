...
public class Board : MonoBehaviour
{
	...
	public List<UnitCard> GetStrongestUnitsOnPlayerBoard()
	{
		...
		List<UnitCard> meleeUnits = GetStrongestUnitsOnRow(GameObject.Find("MeleeRow").GetComponent<DropZone>().currentRow.GetStrongestUnitCards());
		List<UnitCard> rangedUnits = GetStrongestUnitsOnRow(GameObject.Find("RangedRow").GetComponent<DropZone>().currentRow.GetStrongestUnitCards());
		List<UnitCard> siegeUnits = GetStrongestUnitsOnRow(GameObject.Find("SiegeRow").GetComponent<DropZone>().currentRow.GetStrongestUnitCards());
	...
	private List<UnitCard> GetStrongestUnitsOnRow(List<UnitCard> strongestOnRow)
	{
		List<UnitCard> meleeUnits = new List<UnitCard>();
		foreach (UnitCard unit in strongestOnRow)
		{
